...
var userFirstName = Character(readLine()!)
print("please enter your last name")
var userLastName = Character(readLine()!)
...
var counter = 30
for counter in stride(from: 0, to: 30, by: 1) {
print(counter * 2)
    }
...
var animals = ["dog", "cat", "horse", "pig", "cow"]
for item in animals {
    print(item)
    }
print(animals [2])
...
var optionalCdPlayer : String? = "JBL"
if let carmodel = optionalCdPlayer {
    print("The car has a \(optionalCdPlayer) cd player")
} else {
    print("The car does not contain a cd player")
}
